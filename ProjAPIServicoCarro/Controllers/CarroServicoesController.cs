...
namespace ProjAPIServicoCarro.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class CarroServicoesController : ControllerBase
    {
        private readonly ProjAPIServicoCarroContext _context;

        public CarroServicoesController(ProjAPIServicoCarroContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<CarroServico>> PostCarroServico(CarroServico carroServico)
        {
          if (_context.CarroServico == null)
          {
              return Problem("Entity set 'ProjAPIServicoCarroContext.CarroServico'  is null.");
          }
